...
export const S = {
  ...
  topbar: { padding: '12px 18px', borderBottom: '1px solid var(--gray-100)', flexShrink: 0 },
  heading: {
    fontSize: 11, fontWeight: 700, letterSpacing: '0.09em', textTransform: 'uppercase',
    color: 'var(--gray-400)', margin: 0, fontFamily: "'Figtree', sans-serif",
  },
  sections: {
  ...
  card: {
    border: '1px solid var(--gray-200)', borderRadius: 10, overflow: 'visible',
    background: 'var(--white)', width: '100%',
  },
  sectionBtn: {
    width: '100%', padding: '11px 14px', display: 'flex', alignItems: 'center',
    justifyContent: 'space-between', background: 'var(--gray-50)', border: 'none',
    cursor: 'pointer', fontFamily: "'Figtree', sans-serif",
  },
  sectionTitleWrap: { display: 'flex', alignItems: 'center', gap: 10 },
  sectionIcon: {
    width: 28, height: 28, borderRadius: 7, background: 'var(--violet-pale)', color: 'var(--violet-mid)',
    display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
  },
  sectionTitle: {
    fontSize: 13.5, fontWeight: 600, color: 'var(--gray-700)', margin: 0,
    fontFamily: "'Figtree', sans-serif",
  },
  sectionBody: {
    padding: '14px 16px 16px', display: 'flex', flexDirection: 'column', gap: 10,
    borderTop: '1px solid var(--gray-100)', overflow: 'visible',
  },
  ...
  label: {
    fontSize: 11.5, fontWeight: 600, color: 'var(--gray-500)', marginBottom: 0,
    fontFamily: "'Figtree', sans-serif", display: 'block',
  },
  inputWrap: { position: 'relative', width: '100%' },
  inputIcon: {
    position: 'absolute', left: 9, top: '50%', transform: 'translateY(-50%)',
    color: 'var(--gray-400)', pointerEvents: 'none', display: 'flex', alignItems: 'center',
  },
  input: {
    display: 'block', width: '100%', minWidth: 0,
    padding: '8px 11px', fontSize: 13, fontFamily: "'Figtree', sans-serif",
    color: 'var(--gray-800)', background: 'var(--gray-50)', border: '1px solid var(--gray-200)',
  ...
  entry: {
    background: 'var(--gray-50)', border: '1px solid var(--gray-150)', borderRadius: 6,
  ...
  entryNum: {
    ...
    textTransform: 'uppercase', color: 'var(--gray-400)', fontFamily: "'Figtree', sans-serif",
  },
  bulletsArea: { display: 'flex', flexDirection: 'column', gap: 6 },
  bulletRow: { display: 'flex', alignItems: 'center', gap: 7 },
  bulletDot: { color: 'var(--violet-mid)', fontSize: 18, lineHeight: 1, flexShrink: 0 },
  bulletInput: {
    flex: 1, minWidth: 0, padding: '6px 9px', borderRadius: 4,
    border: '1px solid var(--gray-200)', fontSize: 12.5, fontFamily: "'Figtree', sans-serif",
    color: 'var(--gray-700)', background: 'var(--white)', outline: 'none', boxSizing: 'border-box',
  },
  btnAddBullet: {
    display: 'flex', alignItems: 'center', gap: 5, fontSize: 12, fontWeight: 500,
    color: 'var(--indigo-light)', border: 'none', background: 'transparent', padding: '2px 4px',
    cursor: 'pointer', fontFamily: "'Figtree', sans-serif",
  },
  btnRemove: {
    width: 28, height: 28, borderRadius: 4, border: '1px solid transparent',
    background: 'transparent', color: 'var(--gray-400)', display: 'flex',
  ...
  btnAddEntry: {
    ...
    fontSize: 13, fontWeight: 600, color: 'var(--gray-500)', cursor: 'pointer',
    fontFamily: "'Figtree', sans-serif", boxSizing: 'border-box',
  },
  btnAiTrigger: {
    display: 'inline-flex', alignItems: 'center', gap: 7,
    padding: '8px 16px', borderRadius: 6,
    border: '1.5px solid var(--violet-pale)', background: 'var(--violet-faint)',
    fontSize: 13, fontWeight: 600, color: 'var(--violet)', cursor: 'pointer',
    fontFamily: "'Figtree', sans-serif",
  },
  checkbox: {
